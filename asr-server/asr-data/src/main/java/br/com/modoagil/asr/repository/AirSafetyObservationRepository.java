...
/**
 * Repositório de acesso a dados de {@link AirSafetyObservation}
 *
 * @created 17/12/2014
 * @author Bruno César Ribeiro e Silva - <a href="mailto:bruno@brunocesar.com">bruno@brunocesar.com</a>
 * @see GenericRepository
 */
public interface AirSafetyObservationRepository extends GenericRepository<AirSafetyObservation, Long> {
